...
export default function VenueEventCheckout({ event, selectedTicketID, ticketCount }: { event: VenueEventFullDetail, selectedTicketID: string, ticketCount: number }) {
	...
	const handleConfirmBook = () => {
		...
		bookVenueEvent(event.id, purchaseForm)
			.then((res) => {
												...
												<div className="order-total-block">
													<div className="order-total-dt">
														...
														<div className="order-number">
															<span className="text-nowrap" style={{marginRight: '10px'}}>{`${currentTicket.price} * ${ticketCount} =`}</span>
															{currentTicket.price * ticketCount}
														</div>
													</div>
													<div className="order-total-dt">
														<div className="order-text">GST</div>
														<div className="order-number">{currentTicket.tax * ticketCount}</div>
													</div>
													<div className="order-total-dt">
														<div className="order-text">Product Fee</div>
														<div className="order-number">{currentTicket.productFee * ticketCount}</div>
													</div>
