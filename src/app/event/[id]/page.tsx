...
END:VCALENDAR`;
  ...
  return (
    <div className='wrapper'>
      ...
      {checkout ? (
        <Checkout event={event} tickets={count} />
      ) : (
                          ...
                          <>
                            ...
                            <div className='select-ticket-action'>
                              <div className='ticket-price'>{`${
                                event.locale
                              } ${event.price.toLocaleString('en-IN')}`}</div>
                              <div className='quantity'>
                                <div className='counter'>
                                  <span
                                    className='down'
                          ...
                          <div className='xtotel-tickets-count'>
                            ...
                            {!event.isFreeEvent && (
                              <h4>
                                {event.locale}{' '}
                                <span>
                                  {(count * event.price).toLocaleString(
                                    'en-IN'
                                  )}
                                </span>
                              </h4>
              ...
              <div className='col-xl-12 col-lg-12 col-md-12'>
                <div className='more-events'>
                  ...
                  <div className='owl-carousel moreEvents-slider owl-theme'>
                    {events.map((event) => {
                      const price = event.isFreeEvent
                        ? 'Free'
                        : `${event.locale} ${event.price.toLocaleString(
                            'en-IN'
                          )}`;
